...
import redis.transaction.lock.GameTransactionLock;
import redis.transaction.lock.GameTransactionLockInterface;
import redis.transaction.lock.GameTransactionReadLock;
...
public abstract class AbstractGameTransactionEntity implements GameTransactionEntityInterface {
     ...
     * 事务锁
     */
    private redis.transaction.lock.GameTransactionLockInterface gameTransactionLock;
